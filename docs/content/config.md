...
| `storageAdapter` | `string` | `local` (default), `s3`, `ftp`, `sftp`, `webdav` or a [registered](storage-adapters.md) name |
...
| `webdav` | `object` | Options of the `webdav` adapter, required with it ([WebDAV](webdav.md)) |
