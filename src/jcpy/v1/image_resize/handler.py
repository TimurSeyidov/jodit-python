...
from jcpy.services.images import resize_image
...
async def image_resize_handler(context: ActionContext) -> Response:
    """Scale the image name to box[w] x box[h].
